...
class mosse:
    ...
    def start_tracking(self, coords,frame_num, end_frame_num, bounding_box, output_bbox, Video = None, show_prediction=True,show_timing=True):
        ...
        for idx in range(frame_num, x):
            ...
            if show_timing:
            	print('[INFO] MOSSE took {} seconds'.format(time.time()-start))
            # visualize the tracking process...
            if show_prediction:
                cv2.rectangle(current_frame, (pos[0], pos[1]), (pos[0]+pos[2], pos[1]+pos[3]), (255, 0, 0), 6)
                plt.figure(figsize = (15,4)) #change figure size here. native aspect ratio is 16:9
